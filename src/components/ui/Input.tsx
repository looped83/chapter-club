        ...
        <input
          ...
          className={cn(
            ...
            error
              ...
              : 'border-stone-200 dark:border-white/20 hover:border-stone-300 dark:hover:border-white/30 focus:border-brand-400 dark:focus:border-brand-400 focus:shadow-focus-brand dark:focus:shadow-focus-brand-dark',
            className,
          )}
