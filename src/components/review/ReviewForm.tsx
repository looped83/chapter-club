...
export function ReviewForm({ bookId, existing, onSaved }: ReviewFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
      ...
      {/* Emotional Impact */}
      <div>
        <p className="text-sm font-medium text-stone-700 mb-2">Emotionaler Impact</p>
      ...
      {/* Pace */}
      <div>
        <p className="text-sm font-medium text-stone-700 mb-2">Lesetempo</p>
      ...
      {/* Would Reread */}
      <div>
        <p className="text-sm font-medium text-stone-700 mb-2">Würdest du es nochmal lesen?</p>
